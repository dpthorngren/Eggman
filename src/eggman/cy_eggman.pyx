...
cpdef object asymmetricTransit(double rMorning, double rEvening, double rPole, double[:] t, double t0, double period, double semimajor, double inclination, str limbType, object limb, double eccen=0, double lonPeriapse=90., double theta=0., double atol=1e-6, double rtol=1e-3, int max_steps = 200):
    ...
    Args:
        rMorning: The radius of the planet at the morning (right) side of the planet at the equator relative to the stellar radius.
        rEvening: The radius of the planet at the evening (left) side of the planet at the equator relative top the stellar radius.
        rPole: The radius of the planet at the poles (top and bottom) relative to the stellar radius.  If -1, rPole is set to rMorning one morning side and rEvening on the evening side.
