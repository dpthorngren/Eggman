cdef class Shape:
    ...
    def radii(self):
        ...
        return np.array([self.cshape.r_forward, self.cshape.r_back, self.cshape.r_up, self.cshape.r_side])
    ...
    def limb_forward(self):
        ...
        cdef CEllipse ell = self.cshape.f_limb
        return Ellipse(
    ...
    def limb_back(self):
        ...
        cdef CEllipse ell = self.cshape.b_limb
        return Ellipse(
            np.array([ell.e1.x, ell.e1.y, ell.e1.z]),
            np.array([ell.e2.x, ell.e2.y, ell.e2.z]),
        )
    ...
    def joint(self):
        ...
        cdef CEllipse split = self.cshape.joint
        return Ellipse(
    ...
    def __init__(self, double r_forward, double r_back, double r_up, double r_side, double theta=0, double phi=0,
        ...
        '''
        self.cshape = CShape(r_forward, r_back, r_up, r_side)
    ...
    def raycast(self, double x, double y):
        cdef Vec3 loc
        cdef double mu
        cdef bint hit = self.cshape.raycast(x, y, &mu, &loc)
