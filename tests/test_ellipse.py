...
from eggman.cy_eggman import Ellipse
...
def test_rotation_constructor():
    ...
    ell = Ellipse.create_from_rot_radii(2.1, 1.5, rot)
    ...
    ell = Ellipse.create_from_rot_radii(3.0, 1.1, rot)
    ...
    ell = Ellipse.create_from_rot_radii(0.5, 0.9, rot)
    assert ell.e1[2] == 0
    assert ell.e2[2] == 0
...
def test_ellipses():
    for angle, r1, r2 in np.random.rand(20, 3):
        ...
        ell = Ellipse.create_from_rot_radii(r1, r2, rot)
